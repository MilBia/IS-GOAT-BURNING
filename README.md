...
```bash
pip-compile --resolver=backtracking --unsafe-package setuptools -o requirements.txt pyproject.toml
pip-compile --resolver=backtracking --unsafe-package setuptools --extra=cpu -o requirements-cpu.txt pyproject.toml
pip-compile --resolver=backtracking --unsafe-package setuptools --extra=dev,cpu -o requirements-dev.txt pyproject.toml
```
