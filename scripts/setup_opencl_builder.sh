...
# This script sets up the OpenCL builder environment. It uses functions from common.sh
...
# 6. Install additional build dependencies for OpenCV and OpenCL.
echo "Installing OpenCV and OpenCL build dependencies..."
apt-get install -y --no-install-recommends \
